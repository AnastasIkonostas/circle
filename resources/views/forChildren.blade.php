...
<div class="main">
    <div class="info">
        ...
        <p>Чтобы найты выход из комнаты LOCKY , деткам нужно будет ознакомиться с описанием каждой комнаты и рекомендациями, что выбрать понравившийся квест и забронировать его.</p>
